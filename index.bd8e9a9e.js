 ...
 * limitations under the License.
 */
const Ci=()=>function(){if("undefined"!=typeof self)return self;if("undefined"!=typeof window)return window;if(void 0!==t)return t;throw new Error("Unable to locate global object.")}().__FIREBASE_DEFAULTS__,Ai=()=>{try{return Ci()||(()=>{if(void 0===Lt||void 0===Lt.env)return})()||(()=>{if("undefined"==typeof document)return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch(e){return}const t=e&&Ei(e[1]);return t&&JSON.parse(t)})()}catch(e){return void console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`)}},Ri=e=>{var t,n;return null===(n=null===(t=Ai())||void 0===t?void 0:t.emulatorHosts)||void 0===n?void 0:n[e]},Oi=e=>{var t;return null===(t=Ai())||void 0===t?void 0:t[`_${e}`]};
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Cr=new Di("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rr(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const i=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),r=i.name;if("string"!=typeof r||!r)throw Cr.create("bad-app-name",{appName:String(r)});var o;if(n||(n=null===(o=Ai())||void 0===o?void 0:o.config),!n)throw Cr.create("no-options");const a=Ir.get(r);if(a){if(zi(n,a.options)&&zi(i,a.config))return a;throw Cr.create("duplicate-app",{appName:r})}const s=new Ki(r);for(const e of Er.values())s.addComponent(e);const l=new Ar(n,i,s);return Ir.set(r,l),l}function Or(e="[DEFAULT]"){const t=Ir.get(e);if(!t&&"[DEFAULT]"===e)return Rr();if(!t)throw Cr.create("no-app",{appName:e});return t}function Lr(e,t,n){var i;let r=null!==(i=_r[e])&&void 0!==i?i:e;n&&(r+=`-${n}`);const o=r.match(/\s|\//),a=t.match(/\s|\//);if(o||a){const e=[`Unable to register library "${r}" with version "${t}":`];return o&&e.push(`library name "${r}" contains illegal characters (whitespace or "/")`),o&&a&&e.push("and"),a&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void kr.warn(e.join(" "))}Sr(new Xi(`${r}-version`,(()=>({library:r,version:t})),"VERSION"))}let Pr=null;function Dr(){return Pr||(Pr=gr("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw Cr.create("idb-open",{originalErrorMessage:e.message})}))),Pr}async function Mr(e,t){var n;try{const n=(await Dr()).transaction("firebase-heartbeat-store","readwrite"),i=n.objectStore("firebase-heartbeat-store");return await i.put(t,Br(e)),n.done}catch(e){if(e instanceof Pi)kr.warn(e.message);else{const t=Cr.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});kr.warn(t.message)}}}function Br(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Wr;Wr="",Sr(new Xi("platform-logger",(e=>new xr(e)),"PRIVATE")),Sr(new Xi("heartbeat",(e=>new zr(e)),"PRIVATE")),Lr("@firebase/app","0.8.3",Wr),Lr("@firebase/app","0.8.3","esm2017"),Lr("fire-js","");
/**
 * @license
 ...
 * limitations under the License.
 */
Lr("firebase","9.13.0","app");function Hr(e,t){var n={};for(var i in e)Object.prototype.hasOwnProperty.call(e,i)&&t.indexOf(i)<0&&(n[i]=e[i]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var r=0;for(i=Object.getOwnPropertySymbols(e);r<i.length;r++)t.indexOf(i[r])<0&&Object.prototype.propertyIsEnumerable.call(e,i[r])&&(n[i[r]]=e[i[r]])}return n}Object.create;Object.create;function Vr(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const $r=Vr,qr=new Di("auth","Firebase",{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}),Xr=new ir("@firebase/auth");function Gr(e,...t){Xr.logLevel<=Yi.ERROR&&Xr.error(`Auth (9.13.0): ${e}`,...t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Do(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Uo(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Mo(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Fo(t))return"Blackberry";if(Wo(t))return"Webos";if(Bo(t))return"Safari";if((t.includes("chrome/")||zo(t))&&!t.includes("edge/"))return"Chrome";if(jo(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Mo(e=Ni()){return/firefox\//i.test(e)}function Bo(e=Ni()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function zo(e=Ni()){return/crios\//i.test(e)}function Uo(e=Ni()){return/iemobile/i.test(e)}function jo(e=Ni()){return/android/i.test(e)}function Fo(e=Ni()){return/blackberry/i.test(e)}function Wo(e=Ni()){return/webos/i.test(e)}function Ho(e=Ni()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Vo(){return Ti()&&10===document.documentMode}function $o(e=Ni()){return Ho(e)||jo(e)||Wo(e)||Fo(e)||/windows phone/i.test(e)||Uo(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function qo(e,t=[]){let n;switch(e){case"Browser":n=Do(Ni());break;case"Worker":n=`${Do(Ni())}-${e}`;break;default:n=e}return`${n}/JsCore/9.13.0/${t.length?t.join(","):"FirebaseCore-web"}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ts=Oi("authIdTokenMaxAge")||300;let Cs=null;var As;As="Browser",Sr(new Xi("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),{apiKey:r,authDomain:o}=n.options;return((e,n)=>{Zr(r&&!r.includes(":"),"invalid-api-key",{appName:e.name}),Zr(!(null==o?void 0:o.includes(":")),"argument-error",{appName:e.name});const i={apiKey:r,authDomain:o,clientPlatform:As,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:qo(As)},a=new Go(e,n,i);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(io);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(a,t),a})(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Sr(new Xi("auth-internal",(e=>{const t=Ko(e.getProvider("auth").getImmediate());return new Ss(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Lr("@firebase/auth","0.20.11",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(As)),Lr("@firebase/auth","0.20.11","esm2017");const Rs=function(e=Or()){const t=Tr(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Tr(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(zi(n.getOptions(),null!=t?t:{}))return e;Kr(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Ns,persistence:[Wa,Ta,Aa]}),i=Oi("authTokenSyncURL");if(i){const e=(r=i,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>Ts)return;const i=null==t?void 0:t.token;Cs!==i&&(Cs=i,await fetch(r,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){qi(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,i){qi(e).onIdTokenChanged(t,n,i)}(n,(t=>e(t)))}var r;const o=Ri("auth");return o&&Yo(n,`http://${o}`),n}(Rr({apiKey:"AIzaSyC1UwR2UZgcLB74wYfECqB18_hZyQvzmHU",authDomain:"filmoteka-unityjs.firebaseapp.com",projectId:"filmoteka-unityjs",storageBucket:"filmoteka-unityjs.appspot.com",messagingSenderId:"365051232802",appId:"1:365051232802:web:2d7e44860f437e0b39007b",measurementId:"G-BNX13P0P4T",databaseURL:"https://console.firebase.google.com/project/filmoteka-unityjs/database/filmoteka-unityjs-default-rtdb/data/~2F"})),Os={emailInput:document.querySelector("#login-email"),passwordInput:document.querySelector("#login-password"),loginBtn:document.querySelector(".login-btn"),signUpBtn:document.querySelector(".signup-btn"),logoutBtn:document.querySelector("[data-logout]"),openAuthModalBtn:document.querySelector("[data-auth-modal-open]")};Os.loginBtn.addEventListener("click",(async function(){const e=Os.emailInput.value,t=Os.passwordInput.value;0!==e.length&&0!==t.length||ti.Notify.failure("Enter your user credentials");try{const n=await Ea(Rs,e,t);console.log(n.user),window.location.href="index.html"}catch(e){"auth/wrong-password"!==e.code&&"auth/user-not-found"!==e.code||ti.Notify.failure("User not found!Please input correct values!"),console.log(e.code)}})),Os.signUpBtn.addEventListener("click",(async function(){const e=Os.emailInput.value,t=Os.passwordInput.value;0!==e.length&&0!==t.length||ti.Notify.failure("Enter your user credentials");try{const n=await Ia(Rs,e,t);ti.Notify.success("Succes! New user created"),console.log(n.user)}catch(e){"auth/email-already-in-use"===e.code?ti.Notify.failure("Error! User is already exist"):"auth/invalid-email"===e.code||"auth/weak-password"===e.code?ti.Notify.failure("Password must be at least 6 characters"):console.log(e)}})),Os.logoutBtn.addEventListener("click",(async function(){await(e=Rs,qi(e).signOut()),ti.Notify.info("See you"),window.location.href="index.html";var e})),async function(){var e,t,n;e=e=>{e&&(Os.openAuthModalBtn.setAttribute("hidden","hidden"),Os.logoutBtn.removeAttribute("hidden"))},qi(Rs).onAuthStateChanged(e,t,n)}();
//# sourceMappingURL=index.bd8e9a9e.js.map
