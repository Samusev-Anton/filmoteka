 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cr(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const i=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),r=i.name;if("string"!=typeof r||!r)throw Sr.create("bad-app-name",{appName:String(r)});var o;if(n||(n=null===(o=Ti())||void 0===o?void 0:o.config),!n)throw Sr.create("no-options");const a=kr.get(r);if(a){if(Mi(n,a.options)&&Mi(i,a.config))return a;throw Sr.create("duplicate-app",{appName:r})}const s=new Xi(r);for(const e of _r.values())s.addComponent(e);const l=new Tr(n,i,s);return kr.set(r,l),l}function Ar(e="[DEFAULT]"){const t=kr.get(e);if(!t&&"[DEFAULT]"===e)return Cr();if(!t)throw Sr.create("no-app",{appName:e});return t}function Rr(e,t,n){var i;let r=null!==(i=xr[e])&&void 0!==i?i:e;n&&(r+=`-${n}`);const o=r.match(/\s|\//),a=t.match(/\s|\//);if(o||a){const e=[`Unable to register library "${r}" with version "${t}":`];return o&&e.push(`library name "${r}" contains illegal characters (whitespace or "/")`),o&&a&&e.push("and"),a&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void wr.warn(e.join(" "))}Er(new $i(`${r}-version`,(()=>({library:r,version:t})),"VERSION"))}let Lr=null;function Or(){return Lr||(Lr=hr("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw Sr.create("idb-open",{originalErrorMessage:e.message})}))),Lr}async function Pr(e,t){var n;try{const n=(await Or()).transaction("firebase-heartbeat-store","readwrite"),i=n.objectStore("firebase-heartbeat-store");return await i.put(t,Dr(e)),n.done}catch(e){if(e instanceof Li)wr.warn(e.message);else{const t=Sr.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});wr.warn(t.message)}}}function Dr(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
