 ...
 * limitations under the License.
 */
function Ei(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function Ii(){const e="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof e&&void 0!==e.id}function Ni(){const e=Ei();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var jr;jr="",Ir(new $i("platform-logger",(e=>new vr(e)),"PRIVATE")),Ir(new $i("heartbeat",(e=>new Dr(e)),"PRIVATE")),Rr("@firebase/app","0.8.3",jr),Rr("@firebase/app","0.8.3","esm2017"),Rr("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function oo(){return!("undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(io()||Ii()||"connection"in navigator))||navigator.onLine}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eo{_initializeTime(){this.lastSignInTime=vo(this.lastLoginAt),this.creationTime=vo(this.createdAt)}_copy(e){this.createdAt=e.createdAt,this.lastLoginAt=e.lastLoginAt,this._initializeTime()}toJSON(){return{createdAt:this.createdAt,lastLoginAt:this.lastLoginAt}}constructor(e,t){this.createdAt=e,this.lastLoginAt=t,this._initializeTime()}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oo(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Bo(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Po(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Uo(t))return"Blackberry";if(jo(t))return"Webos";if(Mo(t))return"Safari";if((t.includes("chrome/")||Do(t))&&!t.includes("edge/"))return"Chrome";if(zo(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Po(e=Ei()){return/firefox\//i.test(e)}function Mo(e=Ei()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Do(e=Ei()){return/crios\//i.test(e)}function Bo(e=Ei()){return/iemobile/i.test(e)}function zo(e=Ei()){return/android/i.test(e)}function Uo(e=Ei()){return/blackberry/i.test(e)}function jo(e=Ei()){return/webos/i.test(e)}function Fo(e=Ei()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Wo(){return Ni()&&10===document.documentMode}function Ho(e=Ei()){return Fo(e)||zo(e)||jo(e)||Uo(e)||/windows phone/i.test(e)||Bo(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Vo(e,t=[]){let n;switch(e){case"Browser":n=Oo(Ei());break;case"Worker":n=`${Oo(Ei())}-${e}`;break;default:n=e}return`${n}/JsCore/9.13.0/${t.length?t.join(","):"FirebaseCore-web"}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ta extends Ea{_addListener(e,t){}_removeListener(e,t){}constructor(){super((()=>window.sessionStorage),"SESSION")}}Ta.type="SESSION";const Sa=Ta;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const Ns=Ai("authIdTokenMaxAge")||300;let Ts=null;var Ss;Ss="Browser",Ir(new $i("auth",((e,{options:t})=>{const n=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),{apiKey:r,authDomain:o}=n.options;return((e,n)=>{Yr(r&&!r.includes(":"),"invalid-api-key",{appName:e.name}),Yr(!(null==o?void 0:o.includes(":")),"argument-error",{appName:e.name});const i={apiKey:r,authDomain:o,clientPlatform:Ss,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Vo(Ss)},a=new qo(e,n,i);return function(e,t){const n=(null==t?void 0:t.persistence)||[],i=(Array.isArray(n)?n:[n]).map(to);(null==t?void 0:t.errorMap)&&e._updateErrorMap(t.errorMap),e._initializeWithPersistence(i,null==t?void 0:t.popupRedirectResolver)}(a,t),a})(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((e,t,n)=>{e.getProvider("auth-internal").initialize()}))),Ir(new $i("auth-internal",(e=>{const t=Xo(e.getProvider("auth").getImmediate());return new Is(t)}),"PRIVATE").setInstantiationMode("EXPLICIT")),Rr("@firebase/auth","0.20.11",function(e){switch(e){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(Ss)),Rr("@firebase/auth","0.20.11","esm2017");const Cs=function(e=Ar()){const t=Nr(e,"auth");if(t.isInitialized())return t.getImmediate();const n=function(e,t){const n=Nr(e,"auth");if(n.isInitialized()){const e=n.getImmediate();if(Di(n.getOptions(),null!=t?t:{}))return e;Xr(e,"already-initialized")}return n.initialize({options:t})}(e,{popupRedirectResolver:Es,persistence:[ja,Na,Sa]}),i=Ai("authTokenSyncURL");if(i){const e=(r=i,async e=>{const t=e&&await e.getIdTokenResult(),n=t&&((new Date).getTime()-Date.parse(t.issuedAtTime))/1e3;if(n&&n>Ns)return;const i=null==t?void 0:t.token;Ts!==i&&(Ts=i,await fetch(r,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(e,t,n){Vi(e).beforeAuthStateChanged(t,n)}(n,e,(()=>e(n.currentUser))),function(e,t,n,i){Vi(e).onIdTokenChanged(t,n,i)}(n,(t=>e(t)))}var r;const o=Ci("auth");return o&&Ko(n,`http://${o}`),n}(Cr({apiKey:"AIzaSyC1UwR2UZgcLB74wYfECqB18_hZyQvzmHU",authDomain:"filmoteka-unityjs.firebaseapp.com",projectId:"filmoteka-unityjs",storageBucket:"filmoteka-unityjs.appspot.com",messagingSenderId:"365051232802",appId:"1:365051232802:web:2d7e44860f437e0b39007b",measurementId:"G-BNX13P0P4T",databaseURL:"https://console.firebase.google.com/project/filmoteka-unityjs/database/filmoteka-unityjs-default-rtdb/data/~2F"})),As={emailInput:document.querySelector("#login-email"),passwordInput:document.querySelector("#login-password"),loginBtn:document.querySelector(".login-btn"),signUpBtn:document.querySelector(".signup-btn"),logoutBtn:document.querySelector("[data-logout]"),openAuthModalBtn:document.querySelector("[data-auth-modal-open]"),libraryLink:document.querySelector(".js-library")};As.loginBtn.addEventListener("click",(async function(){const e=As.emailInput.value,t=As.passwordInput.value;0!==e.length&&0!==t.length||Jn.Notify.failure("Enter your user credentials");try{const n=await _a(Cs,e,t);console.log(n.user),window.location.href="index.html"}catch(e){"auth/wrong-password"!==e.code&&"auth/user-not-found"!==e.code||Jn.Notify.failure("User not found!Please input correct values!"),console.log(e.code)}})),As.signUpBtn.addEventListener("click",(async function(){const e=As.emailInput.value,t=As.passwordInput.value;0!==e.length&&0!==t.length||Jn.Notify.failure("Enter your user credentials");try{const n=await ka(Cs,e,t);Jn.Notify.success("Succes! New user created"),console.log(n.user)}catch(e){"auth/email-already-in-use"===e.code?Jn.Notify.failure("Error! User is already exist"):"auth/invalid-email"===e.code||"auth/weak-password"===e.code?Jn.Notify.failure("Password must be at least 6 characters"):console.log(e)}})),As.logoutBtn.addEventListener("click",(async function(){await(e=Cs,Vi(e).signOut()),Jn.Notify.info("See you"),window.location.href="index.html";var e})),async function(){var e,t,n;e=e=>{e&&(As.openAuthModalBtn.setAttribute("hidden","hidden"),As.logoutBtn.removeAttribute("hidden"),As.libraryLink.removeAttribute("hidden"))},Vi(Cs).onAuthStateChanged(e,t,n)}();
//# sourceMappingURL=index.3e6acf72.js.map
