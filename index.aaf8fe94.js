 ...
 * limitations under the License.
 */
function Ei(){return"undefined"!=typeof navigator&&"string"==typeof navigator.userAgent?navigator.userAgent:""}function Ni(){const e="object"==typeof chrome?chrome.runtime:"object"==typeof browser?browser.runtime:void 0;return"object"==typeof e&&void 0!==e.id}function Ti(){const e=Ei();return e.indexOf("MSIE ")>=0||e.indexOf("Trident/")>=0}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ar(e,t={}){let n=e;if("object"!=typeof t){t={name:t}}const i=Object.assign({name:"[DEFAULT]",automaticDataCollectionEnabled:!1},t),r=i.name;if("string"!=typeof r||!r)throw Sr.create("bad-app-name",{appName:String(r)});var o;if(n||(n=null===(o=Ci())||void 0===o?void 0:o.config),!n)throw Sr.create("no-options");const a=_r.get(r);if(a){if(Bi(n,a.options)&&Bi(i,a.config))return a;throw Sr.create("duplicate-app",{appName:r})}const s=new Gi(r);for(const e of Ir.values())s.addComponent(e);const l=new Cr(n,i,s);return _r.set(r,l),l}function Rr(e="[DEFAULT]"){const t=_r.get(e);if(!t&&"[DEFAULT]"===e)return Ar();if(!t)throw Sr.create("no-app",{appName:e});return t}function Lr(e,t,n){var i;let r=null!==(i=kr[e])&&void 0!==i?i:e;n&&(r+=`-${n}`);const o=r.match(/\s|\//),a=t.match(/\s|\//);if(o||a){const e=[`Unable to register library "${r}" with version "${t}":`];return o&&e.push(`library name "${r}" contains illegal characters (whitespace or "/")`),o&&a&&e.push("and"),a&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),void xr.warn(e.join(" "))}Nr(new qi(`${r}-version`,(()=>({library:r,version:t})),"VERSION"))}let Or=null;function Pr(){return Or||(Or=mr("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)e.createObjectStore("firebase-heartbeat-store")}}).catch((e=>{throw Sr.create("idb-open",{originalErrorMessage:e.message})}))),Or}async function Dr(e,t){var n;try{const n=(await Pr()).transaction("firebase-heartbeat-store","readwrite"),i=n.objectStore("firebase-heartbeat-store");return await i.put(t,Mr(e)),n.done}catch(e){if(e instanceof Oi)xr.warn(e.message);else{const t=Sr.create("idb-set",{originalErrorMessage:null===(n=e)||void 0===n?void 0:n.message});xr.warn(t.message)}}}function Mr(e){return`${e.name}!${e.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Fr;Fr="",Nr(new qi("platform-logger",(e=>new wr(e)),"PRIVATE")),Nr(new qi("heartbeat",(e=>new Br(e)),"PRIVATE")),Lr("@firebase/app","0.8.3",Fr),Lr("@firebase/app","0.8.3","esm2017"),Lr("fire-js","");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Eo{_initializeTime(){this.lastSignInTime=wo(this.lastLoginAt),this.creationTime=wo(this.createdAt)}_copy(e){this.createdAt=e.createdAt,this.lastLoginAt=e.lastLoginAt,this._initializeTime()}toJSON(){return{createdAt:this.createdAt,lastLoginAt:this.lastLoginAt}}constructor(e,t){this.createdAt=e,this.lastLoginAt=t,this._initializeTime()}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Po(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(zo(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Do(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(jo(t))return"Blackberry";if(Fo(t))return"Webos";if(Mo(t))return"Safari";if((t.includes("chrome/")||Bo(t))&&!t.includes("edge/"))return"Chrome";if(Uo(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Do(e=Ei()){return/firefox\//i.test(e)}function Mo(e=Ei()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function Bo(e=Ei()){return/crios\//i.test(e)}function zo(e=Ei()){return/iemobile/i.test(e)}function Uo(e=Ei()){return/android/i.test(e)}function jo(e=Ei()){return/blackberry/i.test(e)}function Fo(e=Ei()){return/webos/i.test(e)}function Wo(e=Ei()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Ho(){return Ti()&&10===document.documentMode}function Vo(e=Ei()){return Wo(e)||Uo(e)||Fo(e)||jo(e)||/windows phone/i.test(e)||zo(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function $o(e,t=[]){let n;switch(e){case"Browser":n=Po(Ei());break;case"Worker":n=`${Po(Ei())}-${e}`;break;default:n=e}return`${n}/JsCore/9.13.0/${t.length?t.join(","):"FirebaseCore-web"}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sa extends Ea{_addListener(e,t){}_removeListener(e,t){}constructor(){super((()=>window.sessionStorage),"SESSION")}}Sa.type="SESSION";const Ca=Sa;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ps=new so(3e4,6e4);function hs(){const e=Oa().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let ms=null;function gs(e){return ms=ms||function(e){return new Promise(((t,n)=>{var i,r,o;function a(){hs(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{hs(),n(Kr(e,"network-request-failed"))},timeout:ps.get()})}if(null===(r=null===(i=Oa().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Oa().gapi)||void 0===o?void 0:o.load)){const t=Ha("iframefcb");return Oa()[t]=()=>{gapi.load?a():n(Kr(e,"network-request-failed"))},Wa(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}a()}})).catch((e=>{throw ms=null,e}))}(e),ms}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",s),new ks(null);const f=window.open(t||"",s,u);Qr(f,e,"popup-blocked");try{f.focus()}catch(e){}return new ks(f)}function Is(e,t,n,i,r,o){Qr(e.config.authDomain,e,"auth-domain-config-required"),Qr(e.config.apiKey,e,"invalid-api-key");const a={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:i,v:"9.13.0",eventId:r};if(t instanceof la){t.setDefaultLanguage(e.languageCode),a.providerId=t.providerId||"",Mi(t.getCustomParameters())||(a.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(o||{}))a[e]=t}if(t instanceof ca){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(a.scopes=e.join(","))}e.tenantId&&(a.tid=e.tenantId);const s=a;for(const e of Object.keys(s))void 0===s[e]&&delete s[e];return`${function({config:e}){return e.emulator?lo(e,"emulator/auth/handler"):`https://${e.authDomain}/__/auth/handler`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
